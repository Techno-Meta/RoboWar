...
void loop() {
    ...
    server.handleClient();        // listen for HTTP requests from clients
      ...
      else if (command == "1") SPEED = 330;
      else if (command == "2") SPEED = 330;
      else if (command == "3") SPEED = 330;
      else if (command == "4") SPEED = 330;
      else if (command == "5") SPEED = 330;
      else if (command == "6") SPEED = 330;
      else if (command == "7") SPEED = 330;
      else if (command == "8") SPEED = 330;
      else if (command == "9") SPEED = 330;
      else if (command == "q") SPEED = 330;
}
